/**
 * PasteNote — SVG Icon System v4
 * Lucide-style, 24x24 viewBox, stroke-based, clean & minimal.
 */
...
const icons = {
  ...
  note:     '<svg viewBox="0 0 24 24"><path d="M14.5 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>',
  ...
  alertTri: '<svg viewBox="0 0 24 24"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',
};

/**
 * Get SVG icon wrapped in span.
 * Usage: ${icon('lock', 'i-20')}
 */
export function icon(name, sizeClass) {
  const svg = icons[name] || '';
  return '<span class="i ' + (sizeClass || 'i-20') + '">' + svg + '</span>';
}
